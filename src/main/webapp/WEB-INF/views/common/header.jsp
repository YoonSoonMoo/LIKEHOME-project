...
<nav id="navbar" class="navbar row px-0 navbar-light bg-white sticky-top">
  ...
  <div class="scroll-container mt-1 py-2 px-1 text-center">
    <div id="homeTap" class="menu" onclick="location.href='../main/mainPage'">홈</div>
    ...
    <div class="menu" onclick="location.href='../customer/customerShoppingHelpPage'">고객센터</div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
       <div class="row">
       	<div class="col">
       		<div class="fw-bold mb-2">최근 검색어</div>
       		<div class="a">서랍장</div>
       		<div class="a">여름 이불</div>
       		<div class="a">수납 박스</div>
       		<br>
       		<div class="fw-bold mb-1">인기 검색어</div>
       		<div class="a">거실 테이블</div>
       		<div class="a">화분</div>
       		<div class="a">러그</div>
       		<div class="a">베개 커버</div>
       		<div class="a">서랍장</div>
       	</div>
       	<div class="col text-end" style="color:#757575;padding-right: 1rem;">
       		<div class="mb-1">전체 삭제</div>
       		<div class="a">X</div>
       		<div class="a">X</div>
       		<div class="a">X</div>
       	</div>
