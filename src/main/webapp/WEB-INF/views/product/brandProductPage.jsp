...
//scroll paging
    ...
    function getProductList(vendorNo){
		...
		xhr.onreadystatechange = function(){
			...
			if(xhr.readyState == 4 && xhr.status == 200){
			    ...
			    for(DATA of dataList){
			      ...
			      col1.setAttribute("onclick", "location.href='../product/productDetailPage?product_no=" + DATA.PRODUCT_NO + "'");
		          ...
		          imgbox.setAttribute("src", "../../uploadFiles/titleImage/" + DATA.TITLE_IMAGE_LINK);
			      ...
			      row2col1.innerText = DATA.VENDOR_BRAND_NAME;
			      ...
			      row3col1.innerText = DATA.PRODUCT_NAME;
			      ...
			      row4col1.innerText = DATA.PRODUCT_PRICE;
		...
		xhr.open("post", "./restBrandProductPage", false);
		xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xhr.send("vendorNo=" + vendorNo);
     ...
     <div class="row">
     	<div class="col px-0">
     		<div class="brandImgBox">
	            <img class="brandImg" src="../resources/img/brandimg.jpg">
	            <div class="more">탑인테리어</div>
     		</div>
     	</div>
     </div>
